...
- **Mariana (32 anos, profissional liberal)** — advogada, psicóloga, nutricionista, dentista, arquiteta ou personal. Trabalha por conta própria, quer autoridade online, mais agendamentos e parecer mais profissional.
**Equipe:** Solo
**Ferramentas:** —
**Principais entregas:**
- Criação de sites profissionais
- Estruturação e otimização do Perfil da Empresa no Google
- Posicionamento e visibilidade nas pesquisas do Google (SEO)
...
Nome inspirado na constelação Orion — referência de orientação e direção. A Orion atua como guia para empresas que querem crescer no digital.
